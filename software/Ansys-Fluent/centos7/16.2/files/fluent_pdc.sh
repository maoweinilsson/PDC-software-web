...
EXAMPLE:
esubmit -n 2 -t 15 ./fluent-pdc.sh 6 3ddp ./case.jou
Here we requested 2 nodes for 15 minutes with esubmit. 
We chose to take advantage of 6 CPUs per node and run
