...
export MPI_REMSH=/pdc/vol/fire/2017.0/amd64_co7/PDC_bin/ssh

# Run the fire command
fire_cmd -name=fire -no_file_locking -nomapping -mpi -cpu=$ncpus -hostlist=$hosts -project_dir=$PWD -case=Case -solver_vers=v2017
