...
exaqsub -xe6_decomp -decompose  -decomp_target linux_xeonE52680v3_2500 -decomp_log decompose_$SLURM_JOBID.o -xe6 -foreground -simulate -sim_log simulator_$SLURM_JOBID.o -nprocs $NPROCS -num_timesteps $NUM_TIMESTEPS -simoption "-checkpoint 1450000" *.cdi
