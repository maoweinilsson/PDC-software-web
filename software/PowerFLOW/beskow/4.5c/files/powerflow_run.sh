...
###SBATCH  --dependency=246589:2464.5
...
exaqsub -xe6_decomp -decompose -decomp_log decompose_$SLURM_JOBID.o -xe6 -foreground -simulate -sim_log simulator_$SLURM_JOBID.o -nprocs $NPROCS -num_timesteps $NUM_TIMESTEPS -simoption "-checkpoint 144.500" *.cdi
