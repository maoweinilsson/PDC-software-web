...
# Number of timesteps
export NUM_TIMESTEPS=100000

module add powerflow/5.4a
...
exaqsub -xe6_decomp -decompose -decomp_log decompose_$SLURM_JOBID.o -xe6 -foreground -simulate -sim_log simulator_$SLURM_JOBID.o -nprocs $NPROCS -num_timesteps $NUM_TIMESTEPS -simoption "-checkpoint 50000" *.cdi
