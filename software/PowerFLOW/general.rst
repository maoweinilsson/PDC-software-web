...
=================================
PowerFLOW is commercial software, and PDC does not have a license. All licenses to use PowerFLOW at PDC must be supplied by the users.  You can use the environment variable
