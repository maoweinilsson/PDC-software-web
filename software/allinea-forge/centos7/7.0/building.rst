...
Create a volume for allinea-forge/6.1, mount it, download the soruce and extract it::
  ...
  $ fs mkmount 7.1 V.allinea-forge.7.0 -c pdc.kth.se
  $ mkdir /afs/.pdc.kth.se/pdc/vol/allinea-forge/src/
  $ cd /afs/.pdc.kth.se/pdc/vol/allinea-forge/src/
  $ wget http://content.allinea.com/downloads/allinea-forge-7.0-Redhat-7.0-x86_64.tar
  $ tar xvf allinea-forge-7.0-Redhat-7.0-x86_64.tar
  $ cd allinea-forge-7.0-Redhat-7.0-x86_64
...
As install base directory select::
 ...
 /afs/pdc.kth.se/pdc/vol/allinea-forge/7.0/amd64_co7	
