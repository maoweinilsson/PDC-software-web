...
# Load starccm+ v11.04.010 double precision
module load starccm+/11.04.010-dp
...
# Using the POD Key                      
starccm+ -power -podkey f6cP59+o6MaXfV90pgBBcs9//hQ  -licpath 1999@flex.cd-adapco.com -collab -np 48 -pio  $STARTMACRO -batch  -mpidriver intel -nbuserdir $LUSTRE_ROOT ${sim_file}> starccmRun.$SLURM_JOBID.log 2>&1
