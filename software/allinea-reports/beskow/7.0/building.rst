...
Download and extract::
  ...
  $ tar xvf allinea-reports-7.0-Suse-11-x86_64
  $ cd allinea-reports-7.0-Suse-11-x86_64
...
Then we create the profiler libraries::
  ...
  $ mkdir -p /pdc/vol/allinea-reports/7.0/lib/INTEL
  $ cd /pdc/vol/allinea-reports/7.0/lib/INTEL
  $ /pdc/vol/allinea-reports/7.0/bin/make-profiler-libraries --platform=cray --without-shmem

  $ module swap PrgEnv-intel PrgEnv-gnu
  $ mkdir -p /pdc/vol/allinea-reports/7.0/lib/GNU
  $ cd /pdc/vol/allinea-reports/7.0/lib/GNU
  $ /pdc/vol/allinea-reports/7.0/bin/make-profiler-libraries --platform=cray --without-shmem

  $ module swap PrgEnv-gnu PrgEnv-cray
  $ mkdir -p /pdc/vol/allinea-reports/7.0/lib/CRAY
  $ cd /pdc/vol/allinea-reports/7.0/lib/CRAY
  $ /pdc/vol/allinea-reports/7.0/bin/make-profiler-libraries --platform=cray --without-shmem

Also created the following helper script and placed it in /pdc/vol/allinea-reports/7.0/bin/copy-allinea-reports-config:
