To profile a code with Allinea Performance Reports we need to compile it with the module allinea-reports/6.1 loaded::

  $ module load allinea-reports/6.1

If a change of the environment is necessary, make sure you perfom it **before** loading the *allinea-reports/6.1* module. For example ::
