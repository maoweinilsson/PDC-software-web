...
Download and extract::
  ...
  $ tar xvf allinea-reports-6.1-Suse-11-x86_64
  $ cd allinea-reports-6.1-Suse-11-x86_64
...
Then we create the profiler libraries::
  ...
  $ mkdir -p /pdc/vol/allinea-reports/6.1/lib/INTEL
  $ cd /pdc/vol/allinea-reports/6.1/lib/INTEL
  $ /pdc/vol/allinea-reports/6.1/bin/make-profiler-libraries --platform=cray --without-shmem

  $ module swap PrgEnv-intel PrgEnv-gnu
  $ mkdir -p /pdc/vol/allinea-reports/6.1/lib/GNU
  $ cd /pdc/vol/allinea-reports/6.1/lib/GNU
  $ /pdc/vol/allinea-reports/6.1/bin/make-profiler-libraries --platform=cray --without-shmem

  $ module swap PrgEnv-gnu PrgEnv-cray
  $ mkdir -p /pdc/vol/allinea-reports/6.1/lib/CRAY
  $ cd /pdc/vol/allinea-reports/6.1/lib/CRAY
  $ /pdc/vol/allinea-reports/6.1/bin/make-profiler-libraries --platform=cray --without-shmem

Also created the following helper script and placed it in /pdc/vol/allinea-reports/6.1/bin/copy-allinea-reports-config:
