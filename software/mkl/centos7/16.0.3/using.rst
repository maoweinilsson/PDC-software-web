...
The flags for a typical situation, using the intel compiler and 32 bit integers are as follows::
  ...
  LDFLAGS="-L/pdc/vol/i-compilers/16.0.3/icc/mkl/lib/em64t -lmkl_intel_lp64 \
           -lmkl_sequential -lmkl_core -lpthread \
           -Wl,--rpath,/pdc/vol/i-compilers/16.0.3/icc/mkl/lib/em64t"
  CFLAGS="-I/pdc/vol/i-compilers/16.0.3/icc/mkl/include"
